                    ...
                    <div class="panel-body pbody">
                        <div id="navigation_holder">
                            <ul class="pager">
                                ...
                                <span style="font-size:1.3em;font-weight:bold; text-align: center;">Semana 13</span>
                                <li class="next"><a href="/semanas/semana13/{{base64_encode($idA)}}">Siguiente &rarr;</a></li>
                            </ul>
                        </div>
                        <hr>
                        <div class="row">
