...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-group"></i>Editar
    ...
    <div class="panel panel-bordered">
        <div class="panel-body">
            ...
            <div class="form-group col-md-12">
                ...
                <input required type="date" class="form-control" name="fecha_ini"  value="{{$busqueda->desg_fecha_inicio}}" id="fecha_ini">
            </div>
            <div class="form-group col-md-12">

                <label for="name">Fecha de Finalización</label>
                <input required type="date" class="form-control" name="fecha_fin" value="{{$busqueda->desg_fecha_inicio}}"  id="fecha_fin">
            </div>
